...
import com.clickclack.android.autotests.common.ExtentManager;
import com.clickclack.android.autotests.common.AndroidDriverManager;
...
import static com.clickclack.android.autotests.common.ExtentManager.getCurrentTestClass;
    ...
    public void afterInvocation(IInvokedMethod method, ITestResult testResult) {
        ...
        switch (status) {
            ...
            case FAILURE:
                ...
                try {
                    String screenshot = AndroidDriverManager.getScreenshot("FailScreenshot - " + ExtentManager.getCurrentTestMethod().getTest().getName());
        ...
        if (AndroidDriverManager.currentDriver != null) {
            AndroidDriverManager.currentDriver.quit();
        }
    }
}
